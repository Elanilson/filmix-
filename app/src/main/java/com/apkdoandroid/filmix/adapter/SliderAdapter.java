...
public class SliderAdapter extends
    ...
    public void onBindViewHolder(SliderAdapterVH viewHolder, final int position) {
        ...
        Item sliderItem = mSliderItems.get(position);

        viewHolder.textViewDescription.setText(sliderItem.getTitulo());
        viewHolder.textViewDescription.setTextSize(16);
        viewHolder.textViewDescription.setTextColor(Color.WHITE);
      //  Picasso.get()
           //     .load(sliderItem.getUrl_imagem())
           //     .into(viewHolder.imageViewBackground);
        Glide.with(context).load(sliderItem.getUrl_imagem()).into(viewHolder.imageViewBackground);
