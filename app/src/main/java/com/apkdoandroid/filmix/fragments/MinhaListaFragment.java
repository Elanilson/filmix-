...
public class MinhaListaFragment extends Fragment implements ListnerFilme {
    private View view;
    ...
    private TextView textView11InfoFavorito;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_minhalista, container, false);
        ...
        textView11InfoFavorito = view.findViewById(R.id.textView11InfoFavorito);
    ...
    private void recyclerView() {
        ...
        filmes =dao.listarFavoritosFilme();
        if(filmes.size() <= 0){
            textView11InfoFavorito.setVisibility(View.VISIBLE);

        }else {
            textView11InfoFavorito.setVisibility(View.GONE);
